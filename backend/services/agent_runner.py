...
RISK_SYSTEM_PROMPT = """You are Beacon's reasoning engine for supply chain risk assessment.
...
Best regards,
Beacon Supply Chain Intelligence
Beacon Manufacturing — Procurement Operations"""
...
RERUN_PLAN_SYSTEM_PROMPT = """You are Beacon's PlanGenerator. The user REJECTED a previous mitigation plan. Your job is to generate ONE alternative plan that respects the new constraints. Do NOT re-run perception, scoring, or exposure — use the existing risk case context only.
