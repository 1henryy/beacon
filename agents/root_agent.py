...
def build_beacon_root_agent() -> SequentialAgent:
    ...
    pipeline = SequentialAgent(
        name="beacon_root_agent",
        description="Top-level ADK pipeline representing the full Beacon system.",
        sub_agents=[
            perception,
            reasoning,
            planning,
...
async def run_beacon_pipeline(company_id: str, trigger: str, context: dict = None):
    """
