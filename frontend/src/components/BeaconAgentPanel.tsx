...
export default function BeaconAgentPanel() {
    const [messages, setMessages] = useState<{ role: 'user' | 'agent', content: string }[]>([
        { role: 'agent', content: 'Hello Administrator. I am Beacon, your autonomous supply chain resilience agent. How can I assist you today?' }
    ]);
    ...
    return (
        <div className="max-w-4xl mx-auto h-[calc(100vh-8rem)] flex flex-col">
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-slate-900 leading-tight">Beacon Agent Interface</h1>
